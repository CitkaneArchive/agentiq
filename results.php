...
$resultkeys = array_keys($agentIq);
$count=0;
?>
<script type='text/javascript'>
agentIq=new Object();
var agentIq = new Array();
</script>
<?php
foreach ($agentIq as $row){
	?>
	<script type="text/javascript">
	agentIq['<?php echo $resultkeys[$count]; ?>'] = '<?php echo $agentIq[$resultkeys[$count]]; ?>';
	agentIq.<?php echo $resultkeys[$count]; ?> = '<?php echo $agentIq[$resultkeys[$count]]; ?>';
	</script>
	<?php
	$count++;
